...
$data = Spyc::YAMLLoad('../../../../config/parameters.yml');
...
$sentencia = $pdo->prepare("INSERT INTO collection_point
      ( name, description, address_line1, address_line2, created_at, enabled, locality, sub_locality, administrative_level1, country, administrative_level2) 
VALUES(:name,:description,:address_line1,:address_line2,:created_at,:enabled,:locality,:sub_locality,:administrative_level1,:country,:administrative_level2)");
